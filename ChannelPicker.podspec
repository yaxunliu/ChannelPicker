#
# Be sure to run `pod lib lint ChannelPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ChannelPicker.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'ChannelPicker' => ['ChannelPicker/Assets/*.png']
  # }
